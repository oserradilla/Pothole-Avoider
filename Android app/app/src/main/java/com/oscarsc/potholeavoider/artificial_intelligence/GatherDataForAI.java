...
public class GatherDataForAI implements RollingWindowChangesListener {
    ...
    public GatherDataForAI(int windowFrequency, IncidenceReporter incidenceReporter) {
            ...
            if (!hasBeenFilled) {
                ...
                if (firstWindowPieceAccelGyroMagnetoRealWorldWindows != null &&
                    ...
                    if (passesSVMThreshold) {
                        ...
                        new AIPotholes(dataToBeAnalysedByAI, currentIncidenceState, incidenceReporter).start();
                    }
                }
                ...
                if (windowRealWorldCalculusHasBeenFilled) {
                    if (passesSVMThreshold) {
                        ...
                        new AICurves(copyRealWorldCalculusWindow, currentIncidenceState, incidenceReporter).start();
                    }
                }
